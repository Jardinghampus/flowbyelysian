    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>by Derrick Signature Properties</Text>
        </View>
        ...
        <Text style={styles.footer}>
          Generated by Derrick Signature Properties - {new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
        </Text>
