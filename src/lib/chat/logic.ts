  ...
  switch (session.state) {
    case "START":
      ...
      if (hasSearchIntent(message)) {
        ...
        response =
          "Hello! Welcome to Derrick Signature Properties. I can help you find properties in Dubai.\n\n" +
    ...
    case "HANDOFF_PENDING":
      ...
      if (contactInfo.name && contactInfo.phone) {
        response =
          `Thank you, ${contactInfo.name}! An agent from Derrick Signature Properties will contact you at ${contactInfo.phone} shortly.\n\n` +
...
export function getWelcomeMessage(): string {
  return (
    "Hello! Welcome to Derrick Signature Properties.\n\n" +
