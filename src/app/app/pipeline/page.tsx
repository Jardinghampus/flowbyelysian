    ...
    cards: [
      {
        ...
        agent: { name: "Omar K." },
        client: { name: "James Wilson", phone: "+971 50 123 4567", email: "james@example.com" },
        priority: "high",
        daysInStage: 1,
        transactionType: "sale",
        timeline: [
          { id: "t1", date: "2026-03-07", action: "Lead created", by: "System", note: "Inbound from PropertyFinder" },
        ],
        notes: "VIP buyer from London. Budget confirmed. Looking for golf-course facing.",
      },
      {
        id: "p-2",
        title: "2BR Apt — Marina View",
        area: "Dubai Marina",
        ...
        agent: { name: "Sara M." },
        client: { name: "Ahmad R.", phone: "+971 55 987 6543" },
        priority: "medium",
        daysInStage: 3,
        transactionType: "rent",
        timeline: [
          { id: "t2", date: "2026-03-05", action: "Lead created", by: "Sara M." },
          { id: "t3", date: "2026-03-06", action: "First call", by: "Sara M.", note: "Interested, wants viewing this week" },
        ],
        notes: "Corporate tenant. 4 cheques preferred.",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        agent: { name: "Omar K." },
        client: { name: "Fatima A.", email: "fatima@example.com" },
        priority: "high",
        daysInStage: 2,
        transactionType: "sale",
        timeline: [
          { id: "t4", date: "2026-03-02", action: "Lead created", by: "Website" },
          { id: "t5", date: "2026-03-04", action: "Qualified", by: "Omar K.", note: "Family of 5, relocating from Abu Dhabi" },
          { id: "t6", date: "2026-03-06", action: "Viewing booked", by: "Omar K.", note: "Saturday 10 AM" },
        ],
        notes: "Viewing scheduled Saturday 10 AM. Bring school proximity info.",
      },
      {
        id: "p-4",
        ...
        agent: { name: "Sara M." },
        client: { name: "Viktor S." },
        priority: "high",
        daysInStage: 5,
        transactionType: "sale",
        timeline: [
          { id: "t7", date: "2026-02-28", action: "Lead created", by: "Referral" },
          { id: "t8", date: "2026-03-01", action: "First call", by: "Sara M." },
          { id: "t9", date: "2026-03-03", action: "Viewing booked", by: "Sara M.", note: "Private viewing Wednesday" },
        ],
        notes: "UHNW client. Needs private viewing with NDA. Arriving from Moscow.",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        agent: { name: "Omar K." },
        client: { name: "Lisa T.", phone: "+971 52 444 5566" },
        priority: "medium",
        daysInStage: 4,
        transactionType: "sale",
        timeline: [
          { id: "t10", date: "2026-02-25", action: "Lead created", by: "System" },
          { id: "t11", date: "2026-02-27", action: "Viewing done", by: "Omar K.", note: "Liked the unit. Wants to negotiate." },
          { id: "t12", date: "2026-03-01", action: "Offer submitted", by: "Omar K.", note: "AED 2.6M — seller countered at 2.75M" },
          { id: "t13", date: "2026-03-04", action: "Counter offer", by: "Lisa T.", note: "AED 2.7M final — awaiting seller response" },
        ],
        notes: "Gap is only 100K. Push seller to accept 2.7M — motivated buyer, cash ready.",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        agent: { name: "Sara M." },
        client: { name: "David & Emma C." },
        priority: "high",
        daysInStage: 1,
        transactionType: "sale",
        timeline: [
          { id: "t14", date: "2026-02-15", action: "Lead created", by: "Open house" },
          { id: "t15", date: "2026-02-18", action: "Viewing", by: "Sara M." },
          { id: "t16", date: "2026-02-22", action: "Second viewing", by: "Sara M.", note: "Brought architect" },
          { id: "t17", date: "2026-02-28", action: "Offer submitted", by: "Sara M.", note: "AED 7.2M" },
          { id: "t18", date: "2026-03-03", action: "Counter: AED 7.5M", by: "Seller" },
          { id: "t19", date: "2026-03-07", action: "Offer accepted", by: "Sara M.", note: "AED 7.5M — MOU next week" },
        ],
        notes: "MOU signing scheduled for March 12. Conveyancer: Legal Eagles. Deposit: 10%.",
      },
    ],
  },
  {
