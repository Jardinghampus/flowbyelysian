...
- YouTube for virtual tours and market updates`,
  ...
  // Way of Work Modules
  {
    ...
    description: "Learn the basics of using Derrick Signature Properties. This module covers navigation, key features, and best practices.",
    category: "way-of-work",
    content: `## Welcome to Derrick Signature Properties
