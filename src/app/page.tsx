...
import { SmoothScroller } from "@/components/landing/smooth-scroller"
    ...
    <>
      ...
      <SmoothScroller>
        <main className="bg-white">
          ...
          {/* Featured Listings with subtle lag */}
          <section id="properties" data-lag="0.1">
            <FeaturedListings />
          </section>
          ...
          {/* Team Section */}
          <section id="team" data-lag="0.15">
            <TeamSection />
          </section>

          {/* Contact CTA Section */}
          <section id="contact" className="py-24 bg-white">
            <div className="mx-auto max-w-4xl px-4 text-center" data-speed="0.95">
              <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-blue-600" data-lag="0.2">
                Start Your Journey
              </p>
              <h2 className="text-4xl font-bold text-neutral-900 md:text-5xl mb-6" data-lag="0.15">
                Let&apos;s Find Your Perfect Home
              </h2>
              <p className="text-lg text-neutral-600 mb-10 max-w-2xl mx-auto" data-lag="0.1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center" data-lag="0.05">
                <a
